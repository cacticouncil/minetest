...
class NativeEntitySAO : public UnitSAO
{
public:
	NativeEntitySAO() = delete;
	// Used by the environment to load SAO
	NativeEntitySAO(ServerEnvironment *env, v3f pos, const std::string &data);
	// Used by the Lua API
	NativeEntitySAO(ServerEnvironment *env, v3f pos, const std::string &name,
